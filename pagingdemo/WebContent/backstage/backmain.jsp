...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="main">
  <tr>
    ...
    <div class="top"><span class="left">登录IP：127.0.0.1 &nbsp;&nbsp;&nbsp;&nbsp;如非您本人操作，请及时</span><a href="index.html" target="mainFrame" onFocus="this.blur()">更改密码</a></div>
    </td>
  </tr>
  <tr>
    ...
    会员注册：开启<br/>
会员投稿：开启<br/>
管理员个数：<font color="#538ec6"><strong>${usercount }</strong></font> 人<br/>
程序编码：UTF-8<br/>
    </div>
    </td>
  </tr>

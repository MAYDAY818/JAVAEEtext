	...
	<div class="products">	 
		<div class="container">
			...
			<div class="col-md-9 product-model-sec">
                <c:forEach items="${subCakeList }" var="cake">  
				<div class="product-grid">
					<a href="CakeDetailServlet?tiaoId=${cake.cake_class_id }">				
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="${cake.cake_class_image_url }" class="img-responsive" alt="">
							<div class="b-wrapper">
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							<h4>${cake.cake_class_name }</h4>								
							<span class="item_price">${cake.cake_class_price }</span>
							<div class="ofr">
								<p class="pric1"><del>$2300.00</del></p>
								<p class="disc">[15% Off]</p>
							</div>
							<a href="OrderListServletAdd?cakeid=${cake.cake_class_id }">
				...
				<c:if test="${currentPage > 1 }">
					<a href="CakeProdtcts?currentPage=${currentPage - 1 }">上一页</a>
				</c:if>
				<c:if test="${currentPage < pageCount }">
					<a href="CakeProducts?currentPage=${currentPage + 1 }">下一页</a>
				</c:if>
			</div>	
